...
INSERT INTO `__new_location`("id", "name", "slug", "discription", "lat", "lng", "user_id", "created_at", "updated_at") SELECT "id", "name", "slug", "discription", "lat", "lng", "user_id", "created_at", "updated_at" FROM `location`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_locationLog`("id", "name", "description", "lat", "lng", "user_id", "location_id", "created_at", "updated_at") SELECT "id", "name", "description", "lat", "lng", "user_id", "location_id", "created_at", "updated_at" FROM `locationLog`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_locationLogImage`("id", "key", "user_id", "location_log_id", "created_at", "updated_at") SELECT "id", "key", "user_id", "location_log_id", "created_at", "updated_at" FROM `locationLogImage`;--> statement-breakpoint
